...
EnchantCommand::EnchantCommand() : IMCCommand("enchant", "Enchants items", "<enchantment> [level] <mode: auto / manual : 1/0>") {
	...
	enchantMap["protection"] = 0;
	enchantMap["fireprotection"] = 1;
	enchantMap["featherfalling"] = 2;
	enchantMap["blastprotection"] = 3;
	enchantMap["projectileprotection"] = 4;
	enchantMap["thorns"] = 5;
	enchantMap["respiration"] = 6;
	...
	enchantMap["sharpness"] = 9;
	enchantMap["smite"] = 10;
	enchantMap["baneofarthropods"] = 11;
	enchantMap["knockback"] = 12;
	...
	enchantMap["quick_charge"] = 35;
	enchantMap["piercing"] = 34;
	enchantMap["luckofsea"] = 23;
	enchantMap["lure"] = 24;
	enchantMap["soulspeed"] = 36;
}
